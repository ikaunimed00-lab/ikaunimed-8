...
export default function OrganizationMemberCreate({ organization }: { organization: any }) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        // @ts-ignore
        post(route("dashboard.admin.organizations.members.store", organization.id));
    };

    return (
        <AdminLayout>
            <Head title={`Tambah Pengurus - ${organization.name}`} />
